"use client";
import { Shield, Lock, Database, Activity, Minus, Maximize2, X } from "lucide-react";
...
export default function CustomLoader({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-950 flex items-center justify-center relative overflow-hidden">
      ...
      {/* ── Draggable title-bar strip (empty area only) ── */}
      <div
        className="fixed top-0 left-0 right-32 h-10 z-40"
        style={{ WebkitAppRegion: "drag" }}
      />

      {/* ── Window Controls (top-right) — identical to home page ── */}
      <div
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Main gradient orbs */}
        <div className="absolute top-1/4 left-1/4 w-[600px] h-[600px] bg-gradient-to-br from-indigo-500/30 to-purple-500/30 rounded-full blur-3xl animate-float" />
        <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-gradient-to-br from-cyan-500/30 to-blue-500/30 rounded-full blur-3xl animate-float-delayed" />
        <div className="absolute top-1/2 left-1/2 w-[550px] h-[550px] bg-gradient-to-br from-blue-500/20 to-indigo-500/20 rounded-full blur-3xl animate-float-slow" />

        {/* Accent orbs */}
        <div className="absolute top-10 right-20 w-40 h-40 bg-cyan-400/20 rounded-full blur-2xl animate-pulse" />
        <div
      ...
      <div className="relative z-10 text-center px-4">
        ...
        <div className="w-80 max-w-full mx-auto space-y-5">
          <div className="relative h-2 bg-slate-800/50 rounded-full overflow-hidden backdrop-blur-sm border border-white/5">
            ...
            <div className="h-full bg-gradient-to-r from-indigo-500 via-cyan-400 to-blue-500 animate-progress-wave shadow-[0_0_20px_rgba(34,211,238,0.6)]" />
          </div>
      ...
      <style jsx>{`
        ...
        @keyframes float-slow {
          ...
          50%       { transform: translate(40px, 40px) rotate(180deg) scale(1.15); opacity: 0.3; }
        }
        ...
        .animate-float-icon-delayed { animation: float-icon-delayed 5s ease-in-out infinite; }
